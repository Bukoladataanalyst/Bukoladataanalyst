...
🔗 LinkedIn: https://www.linkedin.com/in/adebukola-a-20994a74
...
Credit risk analysis (PD, segmentation, loss drivers)
...
Power BI (DAX, dashboards, executive reporting)
...
Built a PD-based borrower segmentation framework using WOE and logistic regression

Evaluated approval cutoffs and quantified trade-offs between approval volume, default rates, expected loss, and loss-to-revenue

Delivered an executive dashboard simulating current vs policy-driven portfolio outcomes
...
A+ capstone project with faculty commendation
